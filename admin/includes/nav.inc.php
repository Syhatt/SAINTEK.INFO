...
<head>
  ...
  <title>SAINTEK.INFO Admin Panel | <?php echo $page_title ?></title>

  <link href="../assets/css/partials/4-component.css" rel="stylesheet" />
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" />
  <link rel="icon" href="../assets/images/favicon-saintekinfo.png" type="image/x-icon" />
  ...
  <nav class="navbar navbar-default navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand"><img src="../assets/images/logo-saintekinfo.png" /></a>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2 btn-box">
          <a href="./add-category.php" class="btn btn-warning" type="button" style="font-family:Verdana, Geneva, Tahoma, sans-serif; color:black; background-color:#ffa500">
