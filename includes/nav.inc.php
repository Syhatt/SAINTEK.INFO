...
<head>
  ...
  <!-- TITLE OF THE PAGE -->
  <title>SAINTEK.INFO | The Official Info Saintek | <?php echo $page_title; ?></title>
...
<body>
  ...
  <!-- ======== NAVBAR ======== -->
  <nav class="navbar">
    <div class="logo"><a href="./index.php"><img src="./assets/images/logo-saintekinfo.png" /></a></div>
